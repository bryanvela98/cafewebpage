...
def lista_productos(request):
    ...
    if request.method =='POST':
        ...
        return render(request, 'productos.html', {'formproducto': formproducto})
...
def lista_clientes(request):
    ...
    if request.method =='POST':
        ...
        return render(request, 'clientes.html', {'formcliente': formcliente})
...
def lista_pedidos(request):
    ...
    if request.method =='POST':
        ...
        return render(request, 'pedidos.html', {'formpedido': formpedido})
...
def lista_proveedores(request):
    ...
    if request.method =='POST':
        ...
        return render(request, 'proveedores.html', {'formproveedor': formproveedor})
